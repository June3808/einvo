    ...
    var methods = {
        init : function(opts) {
            ...
            block["dom"] = $("<span class='cron-block cron-block-dom'>"
                + "<span> on the</span> <select name='cron-dom'>" + str_opt_dom
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["month"] = $("<span class='cron-block cron-block-month'>"
                + "<span> of</span> <select name='cron-month'>" + str_opt_month
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["mins"] = $("<span class='cron-block cron-block-mins'>"
                + "<span> at</span> <select name='cron-mins'>" + str_opt_mih
            ...
            block["dow"] = $("<span class='cron-block cron-block-dow'>"
                + "<span> on</span> <select name='cron-dow'>" + str_opt_dow
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["time"] = $("<span class='cron-block cron-block-time'>"
                + "<span> at</span> <select name='cron-time-hour' class='cron-time-hour'>" + str_opt_hid
